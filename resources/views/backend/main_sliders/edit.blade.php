                                ...
                                <div class=" {{ $loop->index == 0 ? 'col-md-7' : '' }} col-sm-12 ">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 pt-4">
                                            ...
                                            <textarea name="description[{{ $key }}]" rows="10" class="form-control" id="tinymceExample">{!! old('description.' . $key, $mainSlider->getTranslation('description', $key)) !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12 pt-4">
                                ...
                                <input type="text" name="btn_title" id="btn_title"
                                    value="{{ old('btn_title', $mainSlider->btn_title) }}" class="form-control"
                                    placeholder="">
                                @error('btn_title')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 pt-4">
                                ...
                                <select name="show_btn_title" class="form-control">
                                    <option value="1"
                                        {{ old('show_btn_title', $mainSlider->show_btn_title) == '1' ? 'selected' : null }}>
                                        {{ __('panel.yes') }}
                                    </option>
                                    <option value="0"
                                        {{ old('show_btn_title', $mainSlider->show_btn_title) == '0' ? 'selected' : null }}>
                                        {{ __('panel.no') }}
                                    </option>
                                </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group flatpickr" id="flatpickr-datetime">
                                        <input type="text" name="published_on" class="form-control"
                                            ...
                                            value="{{ old('published_on', Carbon::parse($mainSlider->published_on)->format('Y/m/d h:i A')) }}">
