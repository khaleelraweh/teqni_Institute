...
class EntrustSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $showSupervisors   =  Permission::create(['name' => 'show_supervisors', 'display_name'    =>  ['ar'   =>  'المشرفين',   'en'    =>  'Supervisors'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.index', 'icon' => 'fas fa-user-tie', 'parent' => $manageSupervisors->id, 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $createSupervisors =  Permission::create(['name' => 'create_supervisors', 'display_name'    =>  ['ar'   =>  'إضافة مشرف جديد',   'en'    =>  'Add Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.create', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $displaySupervisors =  Permission::create(['name' => 'display_supervisors', 'display_name'    =>  ['ar'   =>  'عرض مشرف',   'en'    =>  'Dsiplay Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.show', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $updateSupervisors  =  Permission::create(['name' => 'update_supervisors', 'display_name'    =>  ['ar'   =>  'تعديل مشرف',   'en'    =>  'Edit Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.edit', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $deleteSupervisors =  Permission::create(['name' => 'delete_supervisors', 'display_name'    =>  ['ar'   =>  'حذف مشرف',   'en'    =>  'Delete Supervisor'], 'route' => 'supervisors', 'module' => 'supervisors', 'as' => 'supervisors.destroy', 'icon' => null, 'parent' => $manageSupervisors->id, 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        ...
        $manageCollegeMenus = Permission::create(['name' => 'manage_college_menus', 'display_name' => ['ar'    =>  'إدارة اقسام المعهد', 'en'   =>  'Institute Department'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '80',]);
        $manageCollegeMenus->parent_show = $manageCollegeMenus->id;
        $manageCollegeMenus->save();
        $showCollegeMenus    =  Permission::create(['name' => 'show_college_menus',  'display_name' => ['ar'    =>  ' إدارة اقسام المعهد',   'en'    =>  'Manage Institute Department'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $createCollegeMenus  =  Permission::create(['name' => 'create_college_menus', 'display_name'  => ['ar'  =>  ' إضافة قسم معهد',   'en'    =>  'Add Colleges or Institute'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.create', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayCollegeMenus =  Permission::create(['name' => 'display_college_menus', 'display_name'  => ['ar'  =>  'عرض قسم معهد',   'en'    =>  'Display Colleges or Institute'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.show', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateCollegeMenus  =  Permission::create(['name' => 'update_college_menus', 'display_name'  => ['ar'  =>  'تعديل قسم معهد',   'en'    =>  'Edit Colleges or Institute'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.edit', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteCollegeMenus  =  Permission::create(['name' => 'delete_college_menus', 'display_name'  => ['ar'  =>  'حذف قسم معهد',   'en'    =>  'Delete Colleges or Institute'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.destroy', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        ...
        //Institute Department menu
        // $manageCollegeMenus = Permission::create(['name' => 'manage_college_menus', 'display_name' => ['ar'    =>  'إدارة اقسام المعهد', 'en'   =>  'Institute Department'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageWebMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '90',]);
        // $manageCollegeMenus->parent_show = $manageCollegeMenus->id;
        // $manageCollegeMenus->save();
        // $showCollegeMenus    =  Permission::create(['name' => 'show_college_menus',  'display_name' => ['ar'    =>  ' إدارة اقسام المعهد',   'en'    =>  'Manage Institute Department'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '1', 'appear' => '1']);
        // $createCollegeMenus  =  Permission::create(['name' => 'create_college_menus', 'display_name'  => ['ar'  =>  ' إضافة قسم معهد',   'en'    =>  'Add Colleges or Institute'], 'route' => 'college_menus', 'module' => 'college_menus', 'as' => 'college_menus.create', 'icon' => null, 'parent' => $manageCollegeMenus->id, 'parent_original' => $manageCollegeMenus->id, 'parent_show' => $manageCollegeMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        ...
        $manageTracksMenus = Permission::create(['name' => 'manage_tracks_menus', 'display_name' => ['ar'    =>  'إدارة قائمة اختصارات الموقع', 'en'   =>  'Website shortcuts Menu'], 'route' => 'tracks_menus', 'module' => 'tracks_menus', 'as' => 'tracks_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageWebMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '100',]);
        $manageTracksMenus->parent_show = $manageTracksMenus->id;
        $manageTracksMenus->save();
        $showTracksMenus    =  Permission::create(['name' => 'show_tracks_menus',  'display_name' => ['ar'  =>  'إدارة قائمة اختصارات الموقع',   'en'    =>  'Website shortcuts Menu'], 'route' => 'tracks_menus', 'module' => 'tracks_menus', 'as' => 'tracks_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageTracksMenus->id, 'parent_original' => $manageTracksMenus->id, 'parent_show' => $manageTracksMenus->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createTracksMenus  =  Permission::create(['name' => 'create_tracks_menus', 'display_name'  => ['ar'  =>  'إضافة قائمة اختصار',   'en'    =>  'Add Website shortcut Menu Link'], 'route' => 'tracks_menus', 'module' => 'tracks_menus', 'as' => 'tracks_menus.create', 'icon' => null, 'parent' => $manageTracksMenus->id, 'parent_original' => $manageTracksMenus->id, 'parent_show' => $manageTracksMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displayTracksMenus =  Permission::create(['name' => 'display_tracks_menus', 'display_name'  => ['ar'  =>  'عرض قائمة اختصار',   'en'    =>  'Display Website shortcut Menu Link'], 'route' => 'tracks_menus', 'module' => 'tracks_menus', 'as' => 'tracks_menus.show', 'icon' => null, 'parent' => $manageTracksMenus->id, 'parent_original' => $manageTracksMenus->id, 'parent_show' => $manageTracksMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateTracksMenus  =  Permission::create(['name' => 'update_tracks_menus', 'display_name'  => ['ar'  =>  'تعديل قائمة اختصار',   'en'    =>  'Edit Website shortcut Menu Link'], 'route' => 'tracks_menus', 'module' => 'tracks_menus', 'as' => 'tracks_menus.edit', 'icon' => null, 'parent' => $manageTracksMenus->id, 'parent_original' => $manageTracksMenus->id, 'parent_show' => $manageTracksMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteTracksMenus  =  Permission::create(['name' => 'delete_tracks_menus', 'display_name'  => ['ar'  =>  'حذف قائمة اختصار',   'en'    =>  'Delete Website shortcut Menu Link'], 'route' => 'tracks_menus', 'module' => 'tracks_menus', 'as' => 'tracks_menus.destroy', 'icon' => null, 'parent' => $manageTracksMenus->id, 'parent_original' => $manageTracksMenus->id, 'parent_show' => $manageTracksMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        ...
        // $createSupportMenus  =  Permission::create(['name' => 'create_support_menus', 'display_name'  => ['ar'  =>  'إضافة قائمة دعم',   'en'    =>  'Add Support Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.create', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        // $displaySupportMenus =  Permission::create(['name' => 'display_support_menus', 'display_name'  => ['ar'  =>  'عرض قائمة دعم',   'en'    =>  'Display Support Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.show', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        // $updateSupportMenus  =  Permission::create(['name' => 'update_support_menus', 'display_name'  => ['ar'  =>  'تعديل قائمة دعم',   'en'    =>  'Edit Support Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.edit', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        // $deleteSupportMenus  =  Permission::create(['name' => 'delete_support_menus', 'display_name'  => ['ar'  =>  'حذف قائمة دعم',   'en'    =>  'Delete Support Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.destroy', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);

        $manageSupportMenus = Permission::create(['name' => 'manage_support_menus', 'display_name' => ['ar'    =>  'إدارة قائمة الروابط المهمة', 'en'   =>  'Important Links Menu'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageWebMenus->id, 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '105',]);
        $manageSupportMenus->parent_show = $manageSupportMenus->id;
        $manageSupportMenus->save();
        $showSupportMenus    =  Permission::create(['name' => 'show_support_menus',  'display_name' => ['ar'  =>  'إدارة قائمة الروابط المهمة',   'en'    =>  'Important Links Menu'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.index', 'icon' => 'fas fa-bars', 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '1', 'appear' => '1']);
        $createSupportMenus  =  Permission::create(['name' => 'create_support_menus', 'display_name'  => ['ar'  =>  'إضافة قائمة رابط مهم',   'en'    =>  'Add Important Link Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.create', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $displaySupportMenus =  Permission::create(['name' => 'display_support_menus', 'display_name'  => ['ar'  =>  'عرض قائمة رابط مهم',   'en'    =>  'Display Important Link Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.show', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $updateSupportMenus  =  Permission::create(['name' => 'update_support_menus', 'display_name'  => ['ar'  =>  'تعديل قائمة رابط مهم',   'en'    =>  'Edit Important Link Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.edit', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        $deleteSupportMenus  =  Permission::create(['name' => 'delete_support_menus', 'display_name'  => ['ar'  =>  'حذف قائمة رابط مهم',   'en'    =>  'Delete Important Link Menu Link'], 'route' => 'support_menus', 'module' => 'support_menus', 'as' => 'support_menus.destroy', 'icon' => null, 'parent' => $manageSupportMenus->id, 'parent_original' => $manageSupportMenus->id, 'parent_show' => $manageSupportMenus->id, 'sidebar_link' => '0', 'appear' => '0']);
        ...
        $showPages    =  Permission::create(['name' => 'show_page_categories',  'display_name' => ['ar'     => 'إدارة تصنيف الصفحات ', 'en'  =>   'manage Page Categories'], 'route' => 'page_categories', 'module' => 'page_categories', 'as' => 'page_categories.index', 'icon' => 'far fa-file-alt', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $createPages  =  Permission::create(['name' => 'create_page_categories', 'display_name'  => ['ar'     => 'إضافة تصنيف صفحة', 'en'  =>  'Add Page Category'], 'route' => 'page_categories', 'module' => 'page_categories', 'as' => 'page_categories.create', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $displayPages =  Permission::create(['name' => 'display_page_categories', 'display_name'  => ['ar'     => 'عرض تصنيف صفحة', 'en'  =>  'Display Page Category'], 'route' => 'page_categories', 'module' => 'page_categories', 'as' => 'page_categories.show', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $updatePages  =  Permission::create(['name' => 'update_page_categories', 'display_name'  => ['ar'     => 'تعديل تصنيف صفحة', 'en'  =>  'Edit Page Category'], 'route' => 'page_categories', 'module' => 'page_categories', 'as' => 'page_categories.edit', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $deletePages  =  Permission::create(['name' => 'delete_page_categories', 'display_name'  => ['ar'     => 'حذف تصنيف صفحة', 'en'  =>  'Delete Page Category'], 'route' => 'page_categories', 'module' => 'page_categories', 'as' => 'page_categories.destroy', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        ...
        $managePages->save();
        $showPages    =  Permission::create(['name' => 'show_pages',  'display_name' => ['ar'     => 'إدارة الصفحة ', 'en'  =>   'Main Page'], 'route' => 'pages', 'module' => 'pages', 'as' => 'pages.index', 'icon' => 'far fa-file-alt', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $createPages  =  Permission::create(['name' => 'create_pages', 'display_name'  => ['ar'     => 'إضافة صفحة', 'en'  =>  'Add Page'], 'route' => 'pages', 'module' => 'pages', 'as' => 'pages.create', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $displayPages =  Permission::create(['name' => 'display_pages', 'display_name'  => ['ar'     => 'عرض صفحة', 'en'  =>  'Display Page'], 'route' => 'pages', 'module' => 'pages', 'as' => 'pages.show', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $updatePages  =  Permission::create(['name' => 'update_pages', 'display_name'  => ['ar'     => 'تعديل صفحة', 'en'  =>  'Edit Page'], 'route' => 'pages', 'module' => 'pages', 'as' => 'pages.edit', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        $deletePages  =  Permission::create(['name' => 'delete_pages', 'display_name'  => ['ar'     => 'حذف صفحة', 'en'  =>  'Delete Page'], 'route' => 'pages', 'module' => 'pages', 'as' => 'pages.destroy', 'icon' => null, 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);

        // posts
        $managePosts = Permission::create(['name' => 'manage_posts', 'display_name' => ['ar'  =>  'إدارة المدونة',    'en'    =>  'Manage Blogs'], 'route' => 'posts', 'module' => 'posts', 'as' => 'posts.index', 'icon' => 'fab fa-blogger', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '70',]);
        $managePosts->parent_show = $managePosts->id;
        $managePosts->save();
        $showPosts   =  Permission::create(['name'  => 'show_posts', 'display_name'       =>  ['ar'   =>  'المنشورات',   'en'    =>  'Posts'], 'route' => 'posts', 'module' => 'posts', 'as' => 'posts.index', 'icon' => 'fab fa-blogger', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
        ...
        // Statistics
        $manageStatistics = Permission::create(['name' => 'manage_Statistics', 'display_name' => ['ar'  =>  'إدارة إحصائيات المعهد',    'en'    =>  'Manage Statistics'], 'route' => 'statistics', 'module' => 'statistics', 'as' => 'statistics.index', 'icon' => 'far fa-calendar-alt', 'parent' => '0', 'parent_original' => '0', 'sidebar_link' => '1', 'appear' => '1', 'ordering' => '140',]);
        $manageStatistics->parent_show = $manageStatistics->id;
        $manageStatistics->save();
        $showStatistics   =  Permission::create(['name'  => 'show_Statistics', 'display_name'       =>  ['ar'   =>  'إحصائيات المعهد',   'en'    =>  'Statistics'], 'route' => 'statistics', 'module' => 'statistics', 'as' => 'statistics.index', 'icon' => 'far fa-calendar-alt', 'parent' => '0', 'parent_original' => '0', 'parent_show' => '0', 'sidebar_link' => '0', 'appear' => '0']);
